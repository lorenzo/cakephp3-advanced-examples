<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $departmentsEmployee->employee_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $departmentsEmployee->employee_id)]
            )
        ?></li>
...
<div class="departmentsEmployees form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Departments Employee') ?></legend>
        <?php
